...
- `schemas/world-state.json` — world-state API summary schema
- `examples/snapshot.json` — sample response (Experimental devnet metrics when live data is sparse)
